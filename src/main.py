...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--loaded", dest="loaded", type=bool, default=False, help="Option to load and evaluate the model"
    )
    ...
    parser.add_argument(
        "--check_condition", dest="check_condition", type=str, default="acc", help="Option: acc(accuracy) or loss"
    )
