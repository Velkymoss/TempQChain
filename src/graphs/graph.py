...
with Graph("spatial_QA_rule") as graph:
    ...
    tt_quest1, tt_quest2, tt_quest3, tt_quest4 = transitive_topo.has_a(
        arg111=question, arg222=question, arg333=question, arg444=question
    )
    ifL(
        andL(
            answer_class.yes("x"),
            existsL(transitive("t", path=("x", transitive_topo))),
            answer_class.yes(path=("t", tt_quest2)),
            answer_class.yes(path=("t", tt_quest3)),
        ),
